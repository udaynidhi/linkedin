    ...
    <div className='m-2 p-2'>
      ...
      <header className="flex justify-center items-center py-4 ">
        ...
        <div className="flex items-center sm:divide-x divide-gray-300">
          ...
          <Link href="/home" passHref><Image src="/YUV-logo.png" className="mx-auto" width="60" height="60" alt="No Img"></Image></Link>
      ...
      <main className="items-center max-w-screen-lg mx-auto border-2 p-2">
        ...
        <br></br>
        <form className="w-full max-w-lg mx-auto items-center">
              ...
              <Card sx={{ minWidth: 275 }} >
                ...
                <Collapse in={expanded} timeout="auto" unmountOnExit>
                  <CardContent>
                    ...
                    <Button size="small"
                      variant='contained'><a href={job.redirect_url}>Apply Now</a></Button>
                  </CardContent>
                </Collapse>
              </Card>
              <br></br>
